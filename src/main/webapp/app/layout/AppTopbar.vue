        ...
        <div class="layout-topbar-start">
            ...
            <router-link to="/">
                <div class="layout-topbar-logo" id="logolink" style="cursor: pointer; outline: none">
                    <img id="app-logo" alt="poseidon-layout" :src="'/content/layout/images/logo-' + (layoutConfig.topbarTheme.value === 'light' ? 'poseidon' : 'poseidon-dark') + '.png'" />
                </div>
            </router-link>
            <a class="lg:hidden" v-styleclass="{ selector: '@next', enterFromClass: 'hidden', enterActiveClass: 'scalein', leaveToClass: 'hidden', leaveActiveClass: 'fadeout', hideOnOutsideClick: true }">
                <img src="/content/layout/images/avatar-profile.png" alt="demo" class="cursor-pointer" />
            </a>
            <div class="layout-topbar-menu shadow-2 px-3 hidden" style="top: 9rem">
                <ul class="list-none p-0 m-0">
                    <li class="mb-2">
                        <div class="flex gap-3 p-3 bg-primary-600">
                            <img src="/content/layout/images/avatar-profile.png" alt="demo" />
                            ...
                            <ul class="list-none p-0 m-0 flex flex-column">
                                ...
                                <li>
                                    <a class="cursor-pointer flex align-items-center px-3 py-2 gap-3 hover:text-primary">
                                        <img src="/content/demo/images/dashboard/leader-1.png" class="w-2rem h-2rem" />
                                        <div>
                                ...
                                <li>
                                    <a class="cursor-pointer flex align-items-center px-3 py-2 gap-3 hover:text-primary">
                                        <img src="/content/demo/images/dashboard/leader-2.png" class="w-2rem h-2rem" />
                                        <div>
                                ...
                                <li>
                                    <a class="cursor-pointer flex align-items-center px-3 py-2 gap-3 hover:text-primary">
                                        <img src="/content/demo/images/dashboard/leader-3.png" class="w-2rem h-2rem" />
                                        <div>
                                ...
                                <li>
                                    <a class="cursor-pointer flex align-items-center px-3 py-2 gap-3 hover:text-primary">
                                        <img src="/content/demo/images/dashboard/leader-4.png" class="w-2rem h-2rem" />
                                        <div>
